...
HD_PWD='/home/student/Desktop/PSDS_FINALNA/IP_mina_opacic/IP_mina_opacic.runs/MLP_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MLP_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MLP_auto_pc_0.tcl
