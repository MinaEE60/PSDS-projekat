...
HD_PWD='/home/student/Desktop/PSDS_FINALNA/IP_mina_opacic/IP_mina_opacic.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MLP_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MLP_wrapper.tcl -notrace
