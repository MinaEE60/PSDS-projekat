...
HD_PWD='/home/mina/Downloads/IP_JEZGRO/IP_JEZGRO.runs/IP_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IP_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IP_0.tcl
