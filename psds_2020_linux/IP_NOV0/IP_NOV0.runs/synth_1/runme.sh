...
HD_PWD='/home/mina/Downloads/IP_NOV0/IP_NOV0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MLP1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MLP1_wrapper.tcl
