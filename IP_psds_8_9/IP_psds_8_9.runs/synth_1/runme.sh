...
HD_PWD='C:/Users/student/Downloads/psds/PSDS_FINALNA/IP_psds_8_9/IP_psds_8_9.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log psds_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source psds_wrapper.tcl
