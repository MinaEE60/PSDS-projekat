...
HD_PWD='C:/Users/student/Downloads/psds/PSDS_FINALNA/IP_psds_8_9/IP_psds_8_9.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log psds_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source psds_wrapper.tcl -notrace
